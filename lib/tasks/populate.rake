namespace :db do
  ...
  task :populate => :environment do
    ...
    FactoryGirl.create(:message, organization_id: @summiteers.id, sender_id: @summit_leader.id, message_text: "Welcome to the organization!", date_time: Time.now.beginning_of_day())
    FactoryGirl.create(:message, organization_id: @summiteers.id, sender_id: @summiteer1.id, date_time: Time.now.beginning_of_hour())
    FactoryGirl.create(:message, organization_id: @summiteers.id, sender_id: @summiteer2.id, date_time: Time.now.beginning_of_minute())
